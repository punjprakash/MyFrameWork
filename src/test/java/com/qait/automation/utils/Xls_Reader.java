...
public class Xls_Reader {
	...
	public static String setdataFilePath(String appName) {
		
		String env = getProperty("Config.properties", "env").trim();
		
		if (env.equalsIgnoreCase("conv01")&appName.equalsIgnoreCase("ASR")) {
			dataFilePath = "src/test/resources/testdata/Conv01/ASR/TestData.xlsx";
			
		} else if (env.equalsIgnoreCase("conv02")&appName.equalsIgnoreCase("ASR")) {
			dataFilePath = "src/test/resources/testdata/Conv02/ASR/TestData.xlsx";
			
		} else if(env.equalsIgnoreCase("conv03")&appName.equalsIgnoreCase("ASR")) {
			dataFilePath = "src/test/resources/testdata/Conv03/ASR/TestData.xlsx";
    ...
    //To provide the map of excel 
    
    public static Object[][] getData(String testCase,Xls_Reader xls){
		System.out.println("*****Getting data from excelsheet ********");
		...
		*/
		...
		String value=xls.getCellData(testCase, cols, colStartRowNum);
		...
		// rows
		int rowStartRowNum=1;
		int rows=0;
		while(!xls.getCellData(testCase, 1, (rowStartRowNum+rows)).equals("")){
			rows++;
		}
		...
		for(int rNum=1;rNum<=(rows-1);rNum++){
			...
			for(int cNum=0;cNum<cols;cNum++){
				...
				table.put(xls.getCellData(testCase, cNum, colStartRowNum),xls.getCellData(testCase, cNum, rNum+1));
    ...
    public static Hashtable<String,String> getDataOneRow(String testCase,Xls_Reader xls){
		System.out.println("*****Getting data from excelsheet ********");
		int colStartRowNum=1;
		int cols=0;
		String value=xls.getCellData(testCase, cols, colStartRowNum);
		...
		// print the test data
			table=new Hashtable<String,String>();
			for(int cNum=0;cNum<cols;cNum++){
				table.put(xls.getCellData(testCase, cNum, colStartRowNum),xls.getCellData(testCase, cNum, 2));
				}
